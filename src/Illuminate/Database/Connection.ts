...
import { Grammar as QueryGrammar, Processor, type Bindings, type BindingsKeys } from "./Query";
...
export class Connection {
  ...
  //  * @return mixed
  //  */
  // public selectOne($query, $bindings = [], $useReadPdo = true)
  // {
  ...
  //  */
  // public scalar($query, $bindings = [], $useReadPdo = true)
  // {
  ...
  //  * @return array
  //  */
  // public selectFromWriteConnection($query, $bindings = [])
  // {
  ...
  //  * @return array
  //  */
  // public selectResultSets($query, $bindings = [], $useReadPdo = true)
  // {
  //     return $this->run($query, $bindings, ($query, $bindings) use ($useReadPdo) {
  //         if ($this->pretending()) {
  //             return [];
  //         }
  ...
  //  */
  // public cursor($query, $bindings = [], $useReadPdo = true)
  // {
  //     $statement = $this->run($query, $bindings, ($query, $bindings) use ($useReadPdo) {
  //         if ($this->pretending()) {
  //             return [];
  //         }
  ...
  //  * @return int
  //  */
  // public affectingStatement($query, $bindings = [])
  // {
  //     return $this->run($query, $bindings, ($query, $bindings) {
  //         if ($this->pretending()) {
  //             return 0;
  ...
  //  */
  // public pretend(Closure $callback)
  // {
  ...
  //  * @return mixed
  //  */
  // public withoutPretending(Closure $callback)
  // {
  //     if (! $this->pretending) {
  //         return $callback();
  //     }
  ...
  //  * @return array{query: string, bindings: array, time: float|null}[]
  //  */
  // protected withFreshQueryLog($callback)
  // {
  ...
  //  * @return void
  //  */
  // public whenQueryingForLongerThan($threshold, $handler)
  // {
  ...
  //  * @return void
  //  */
  // public allowQueryDurationHandlersToRunAgain()
  // {
  ...
  //  * @return void
  //  */
  // public resetTotalQueryDuration()
  // {
  ...
  //  * @return $this
  //  */
  // public beforeStartingTransaction(Closure $callback)
  // {
  ...
  //  * @return $this
  //  */
  // public beforeExecuting(Closure $callback)
  // {
  ...
  //  * @return void
  //  */
  // public listen(Closure $callback)
  // {
  ...
  //  * @return array|null
  //  */
  // protected fireConnectionEvent($event)
  // {
  ...
  //  * @return $this
  //  */
  // public setReadPdoConfig(array $config)
  // {
  ...
  //  * @return $this
  //  */
  // public setQueryGrammar(Query\Grammars\Grammar $grammar)
  // {
  ...
  //  * @return $this
  //  */
  // public setEventDispatcher(Dispatcher $events)
  // {
  //     $this->events = $events;
  ...
  //  * @return void
  //  */
  // protected executeBeginTransactionStatement()
  // {
  ...
  //  * @return $this
  //  */
  // public setTransactionManager($manager)
  // {
  ...
  //  * @return $this
  //  */
  // public setReadWriteType($readWriteType)
  // {
  ...
  //  * @return mixed
  //  */
  // public withoutTablePrefix(Closure $callback): mixed
  // {
  ...
  //  * @return void
  //  */
  // public static resolverFor($driver, Closure $callback)
  // {
  ...
  //  * @return \Closure|null
  //  */
  // public static getResolver($driver)
  // {
