...
import { Grammar as QueryGrammar, Processor } from "./Query";
...
export class Connection {
    ...
    protected pdo: Statement | Function | any; // TODO: verify the real type and remove the any;
     ...
     */
    constructor(
      pdo: Statement | Function | any, // TODO: verify the real type and remove the any
      database: string = '',
      tablePrefix: string = '',
      config: any[] = []
    ) {
